    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            <button
                type="button"
                wire:click.prevent="vote"
                class="w-32 h-11 text-xs bg-blue text-white font-semibold uppercase rounded-xl border border-blue hover:border-blue-hover transition duration-150 ease-in px-6 py-3"
            >
                <span>Vote</span>
            </button>
            @else
