<div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen">
      ...
      Leaving: "ease-in duration-200"
        ...
        To: "opacity-0"
    -->
        <div class="fixed inset-0 bg-blue bg-opacity-60 transition-opacity" aria-hidden="true"></div>
    ...
    -->
        <div class="modal bg-white rounded-tl-xl rounded-tr-xl overflow-hidden transform transition-all py-4 sm:max-w-2xl sm:w-full">
