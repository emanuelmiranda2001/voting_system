                ...
                <div class="hidden md:block border-r border-gray-100 px-5 py-8">
                    ...
                    <div class="mt-8">
                        ...
                        <button
                            ...
                            class="w-20 bg-blue text-white border border-blue hover:border-blue-hover font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3"
                        >
                            Vote
                        </button>
                        @else
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                            ...
                            <div class="flex items-center md:hidden mt-4 md:mt-0">
                                ...
                                <button
                                    type="button"
                                    wire:click.prevent="vote"
                                    class="w-20 bg-blue border border-blue text-white font-bold text-xs uppercase rounded-xl hover:border-blue-hover transition duration-150 ease-in px-4 py-3 -mx-5"
                                >
                                    <span>Vote</span>
                                </button>
                                @else
